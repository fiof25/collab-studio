              ...
              editing ? (
                <div className="flex items-center gap-1.5">
                  <input
                    ...
                    className="text-sm font-semibold font-mono bg-transparent border-b border-white/30 text-ink-primary focus:outline-none max-w-[200px]"
                  />
                </div>
              ) : (
                <button
                ...
                >
                  <span
                    className="text-sm font-semibold truncate max-w-[200px] text-ink-primary"
                  >
